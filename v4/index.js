...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:hakoshi\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5517992719672:+55 17992719672\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '/','*','.'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD HAKOSHI BOT*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de hakoshi. Registre-se para fazer amizade com o bot Hakoshi por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar hakoshi|18\n\n──「 Hakoshi BOT 」──`,
			...
			const ownerNumber = ["5517992719672@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5517992719672@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5517992719672@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5517992719672@s.whatsapp.net"]//ubah nomor lo
			const premium = ["5517992719672@s.whatsapp.net","559784130980@s.whatsapp.net"]
...
// recursos anime, random @nabuto domina vida
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT HAKOSHI ✨* 」\n*│+ wa.me/5517992719672*╰──────*「 *hakoshi* 」*────*\n\n*_SE QUER SER ADMIN DO BOT HAKOSHI_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
